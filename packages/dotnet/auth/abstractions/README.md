...
bootstrap — all in `DcsvIo.D2.Context.Abstractions`
...
fails closed by construction — a host capability authority that consumes
`RequestOrigin` denies rather than assume a plane.
...
- `DcsvIo.D2.Messaging.RabbitMq` — context propagation across AMQP
- RFC 8693 — OAuth 2.0 Token Exchange (`act` chain semantics): https://datatracker.ietf.org/doc/html/rfc8693
