...
export const TIMEZONE_CODE_SET: ReadonlySet<string> = new Set([
  "Africa/Abidjan",
  "Africa/Algiers",
  "Africa/Bissau",
  "Africa/Cairo",
...
export const TimezoneCodeSchema = z
  .string()
  .refine((s): s is TimezoneCode => TIMEZONE_CODE_SET.has(s), { message: "value is not a known TimezoneCode" });
 ...
 * untrusted input always use `TimezoneCodeSchema.parse(...)`.
 */
export function asTimezoneCode(value: string): TimezoneCode { return value as TimezoneCode; }
