...
export const LOCALE_CODE_SET: ReadonlySet<string> = new Set([
  "aa",
  "aa-DJ",
  "aa-ER",
  "aa-ET",
...
export const LocaleCodeSchema = z
  .string()
  .refine((s): s is LocaleCode => LOCALE_CODE_SET.has(s), { message: "value is not a known LocaleCode" });
 ...
 * untrusted input always use `LocaleCodeSchema.parse(...)`.
 */
export function asLocaleCode(value: string): LocaleCode { return value as LocaleCode; }
