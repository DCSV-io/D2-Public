...
export const EncryptionDomains = {
  ...
  PLAINTEXT: "plaintext",
  /**
   * Public framework fixture domain for Shared.Tests sealed-path unit coverage of EncryptionDomainModes + EncryptedBodyComposer. Not a product keyring domain — hosts register product sealed domains (audit / notifications / courier) at composition time.
   */
