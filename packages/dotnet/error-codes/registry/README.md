...
Generated by `DcsvIo.D2.ErrorCodes.Registry.SourceGen` (`RegistryGenerator`) from `contracts/error-codes/error-codes.spec.json` + all `contracts/**/*-error-codes.spec.json` files. Never hand-edit `Generated/.../ErrorCodeRegistry.g.cs` — change the spec and rebuild.
