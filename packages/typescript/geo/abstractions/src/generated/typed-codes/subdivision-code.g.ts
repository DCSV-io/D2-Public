...
export const SUBDIVISION_CODE_SET: ReadonlySet<string> = new Set([
  "AD-02",
  "AD-03",
  "AD-04",
  "AD-05",
...
export const SubdivisionCodeSchema = z
  .string()
  .refine((s): s is SubdivisionCode => SUBDIVISION_CODE_SET.has(s), { message: "value is not a known SubdivisionCode" });
 ...
 * untrusted input always use `SubdivisionCodeSchema.parse(...)`.
 */
export function asSubdivisionCode(value: string): SubdivisionCode { return value as SubdivisionCode; }
